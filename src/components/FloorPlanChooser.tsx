  ...
  return (
    <div className="relative h-full w-full bg-black overflow-hidden">
      ...
      */}
      ...
      {/*
        Mobile: parked tight against the fullscreen toggle button's corner (right-16, not
        centered) so it stays clear of the hall marker at x:50%/y:88%. Sized to its short
        text on one line (w-max + nowrap), centered within its own pill.
        sm and up: back to the original centered, single-line placement.
      */}
